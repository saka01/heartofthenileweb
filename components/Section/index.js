...
export const Section = {
            ...
            <div className="w-full md:w-4/6 py-24 mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-10">
              <div className="popular__items__large rounded row-span-2">
                <div className="bg-[rgba(0,0,0,.3)] h-full p-10 flex flex-col justify-center group hover:bg-[rgba(0,0,0,.15)]">
                  <h3 className="text-3xl md:text-5xl text-white font-semibold">Special<br/> Delicacy</h3>
                  <p className="mt-5 mb-10 text-white font-medium tracking-wide">Sweet food from <br/> <span className="text-red-600 font-semibold">The heart of the Nile</span></p>
                  <Button.Secondary label="order now" icon={false} />
                </div>
              </div>
              <div className="popular__items__1 rounded">
                <div className="bg-[rgba(0,0,0,.3)] h-full p-10 flex flex-col justify-center group hover:bg-[rgba(0,0,0,.15)]">
                  <h3 className="text-3xl text-white font-semibold">Enjoy our <br/>Delicious Meal</h3>
              ...
              <div className="popular__items__2 rounded">
                <div className="bg-[rgba(0,0,0,.3)] h-full p-10 flex flex-col justify-center group hover:bg-[rgba(0,0,0,.15)]">
                  <h3 className="text-3xl text-white font-semibold">The Best North African food in <span className="text-red-600">Ottawa, ON</span></h3>
                  <p className="mt-5 mb-10 text-white font-medium tracking-wide"></p>
                  <Button.Secondary label="order now" icon={false} />
                </div>
              </div>  
    ...
    Testimonial: () => {
        return(
            ...
            <div className="text-center">
              <span className="bg-red-100 p-10 text-sm font-semibold tracking-wide rounded text-red-500">Testimonial</span>
              <h2 className="text-4xl text-gray-900 font-bold my-20">What Our Customers Say</h2>
            </div>
    ...
    FooterFirst: () => {
        return(
            <section id="footer-first" className="footer-first"></section>
        )
    }
};